...
public class loginFrame extends JFrame {
	...
	public loginFrame() {
		...
		lblAvtUser.setIcon(
				new ImageIcon(Toolkit.getDefaultToolkit().createImage(loginFrame.class.getResource("user2.png"))));
		...
		lbliconPass.setIcon(
				new ImageIcon(Toolkit.getDefaultToolkit().createImage(loginFrame.class.getResource("pass-icon.png"))));
		...
		lblPort.setIcon(
		new ImageIcon(Toolkit.getDefaultToolkit().createImage(loginFrame.class.getResource("connect.png"))));
